...
console.log(input)
        ...
        $.get("/chat", queryParams)
            .done(function(resp) {
                ...
                var nextListItem = "<li class='list-group-item list-group-item-warning text-right'>" + "Eliza : " + resp + "</li>";
                setTimeout(function() {
                ...
                var nextListItem = "<li class='list-group-item list-group-item-danger' >Knock knock! Whos there? Not me!</li>";
                listItem.append(nextListItem);
            });
